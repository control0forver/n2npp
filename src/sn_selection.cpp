...
#include "n2n.h"              // for peer_info, n2n_edge, SN_SELECTION_CRIT...
...
static SN_SELECTION_CRITERION_DATA_TYPE sn_selection_criterion_common_read (n2n_edge *eee);
static int sn_selection_criterion_sort (peer_info *a, peer_info *b);
