...
#include "n2n.h"     // for n2n_edge_conf, edge_conf_add_supernode, edge_init
...
int main() {
    ...
    snprintf((char *)conf.co    mmunity_name, sizeof(conf.community_name), "%s", "mycommunity"); // Community to connect to
