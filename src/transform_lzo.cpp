...
#include "n2n.h"        // for n2n_trans_op, TRACE_ERROR, traceEvent, N2N_...
...
static int transop_deinit_lzo (n2n_trans_op *arg) {
...
static int transop_encode_lzo (n2n_trans_op *arg,
                               uint8_t *outbuf,
                               size_t out_len,
                               const uint8_t *inbuf,
                               size_t in_len,
...
static int transop_decode_lzo (n2n_trans_op *arg,
                               uint8_t *outbuf,
                               size_t out_len,
                               const uint8_t *inbuf,
                               size_t in_len,
...
static void transop_tick_lzo (n2n_trans_op *arg, time_t now) {
...
int n2n_transop_lzo_init (const n2n_edge_conf *conf, n2n_trans_op *ttt) {
    ...
    ttt->transform_id = (n2n_transform)N2N_COMPRESSION_ID_LZO;
