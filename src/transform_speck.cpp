...
#include "n2n.h"             // for n2n_trans_op, traceEvent, TRACE_DEBUG
...
static int transop_deinit_speck (n2n_trans_op *arg) {
...
//       |<---- encrypted ---->|
//
static int transop_encode_speck (n2n_trans_op *arg,
                                 uint8_t *outbuf,
                                 size_t out_len,
                                 const uint8_t *inbuf,
                                 size_t in_len,
...
static int transop_decode_speck (n2n_trans_op *arg,
                                 uint8_t *outbuf,
                                 size_t out_len,
                                 const uint8_t *inbuf,
                                 size_t in_len,
...
static void transop_tick_speck (n2n_trans_op *arg, time_t now) {
