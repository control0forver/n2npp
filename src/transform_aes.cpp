...
static int transop_deinit_aes (n2n_trans_op *arg) {
...
//  | <---- encrypted ---->  |
//
static int transop_encode_aes (n2n_trans_op *arg,
                               uint8_t *outbuf,
                               size_t out_len,
                               const uint8_t *inbuf,
                               size_t in_len,
...
static int transop_decode_aes (n2n_trans_op *arg,
                               uint8_t *outbuf,
                               size_t out_len,
                               const uint8_t *inbuf,
                               size_t in_len,
...
static void transop_tick_aes (n2n_trans_op *arg, time_t now) {
