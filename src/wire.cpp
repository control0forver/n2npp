...
#include "n2n.h"         // for n2n_sock, n2n_common, n2n_auth, n2n_RE...
...
int decode_REGISTER (n2n_REGISTER *reg,
    ...
    size_t retval = 0;
    memset(reg, 0, sizeof(n2n_REGISTER));
...
int decode_REGISTER_SUPER (n2n_REGISTER_SUPER *reg,
                           const n2n_common *cmn, /* info on how to interpret it */
                           const uint8_t *base,
                           size_t *rem,
                           size_t *idx) {
    ...
    size_t retval = 0;
    memset(reg, 0, sizeof(n2n_REGISTER_SUPER));
...
int decode_REGISTER_ACK (n2n_REGISTER_ACK *reg,
                         const n2n_common *cmn, /* info on how to interpret it */
                         const uint8_t *base,
                         size_t *rem,
                         size_t *idx) {
    ...
    size_t retval = 0;
    memset(reg, 0, sizeof(n2n_REGISTER_ACK));
...
int decode_REGISTER_SUPER_ACK (n2n_REGISTER_SUPER_ACK *reg,
    ...
    size_t retval = 0;
    memset(reg, 0, sizeof(n2n_REGISTER_SUPER_ACK));
...
int fill_n2nsock (n2n_sock* sock, const struct sockaddr* sa) {
...
int decode_PACKET (n2n_PACKET * pkt,
    ...
    size_t retval = 0;
    memset(pkt, 0, sizeof(n2n_PACKET));
...
int decode_PEER_INFO (n2n_PEER_INFO *pkt,
    ...
    size_t retval = 0;
    memset(pkt, 0, sizeof(n2n_PEER_INFO));
...
int decode_QUERY_PEER (n2n_QUERY_PEER * pkt,
    ...
    size_t retval = 0;
    memset(pkt, 0, sizeof(n2n_QUERY_PEER));
